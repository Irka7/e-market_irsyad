...
@section('content')
    ...
    <section class="content">
        ...
        <div class="card">
            ...
            @endif
                <form method="POST" id="formTransaksi" action="pembelian">
                    ...
                    <div class="row">
                        ...
                        <div class="col-6">
                            ...
                            <div class="col-md-6 col-sm-6 col-xs-12">
                                <input class="date-picker form-control col-md-7 col-xs-12" required="required" name="tanggal_masuk" type="date"  value="{{ date('Y-m-d') }}">
                            </div>
                        </div>
                    </div>
                    <div class="row">
...
@push('script')
    <script>
        ...
        function calcSubTotal(a){
            ...
            $('#totalHarga').val(totalHarga);
            console.log(`qty = ${qty} hargaBarang = ${hargaBarang} subTotalAwal = ${subTotalAwal} subTotal = ${subTotal}`)
        }
    </script>
@endpush
